...
namespace TheGallop_Resort.Api.DTOs
{
    ...
    public record CreateRoomReservationDTO (int bookingId, DateOnly CheckIn, DateOnly CheckOut, int Adults, int Children, RoomType Type );
    ...
    public record CreateNewRoomReservationWithBookingIdDTO (int bookingId, DateOnly CheckIn, DateOnly CheckOut, int Adults, int Children, RoomType Type);

    public record RoomDetailResponse(int Id, int RoomNumber);
}
